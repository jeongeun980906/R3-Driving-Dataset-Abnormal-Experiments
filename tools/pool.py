...
class AL_pool():
    def __init__(self,root='./dataset',num_init=100,exp_case=[1,2,3],norm=True,N_OBJECTS=None):
        self.basedata=total_dataset(root=root,norm=norm,exp_case=exp_case,N_OBJECTS=N_OBJECTS)
        self.batch_size=128
