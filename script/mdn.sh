cd ..
python main.py --gpu 1 --init_pool 500 --query_size 250 --id 4 --exp_case 2 3 
python main.py --gpu 1 --query_method aleatoric --init_pool 500 --query_size 250 --id 4 --exp_case 2 3 
python main.py --gpu 1 --query_method pi_entropy --init_pool 500 --query_size 250 --id 4 --exp_case 2 3 
python main.py --gpu 1 --query_method random --init_pool 500 --query_size 250 --id 4 --exp_case 2 3 
